document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizQuestionsData = [
        '<p>1. 独断で物事を進める社長の<span class="blank" data-correct-answer="専横"></span> な態度に、社員は不満を募らせた。</p>',
        '<p>2. 成功を収めた後も、彼は<span class="blank" data-correct-answer="謙虚"></span> な姿勢を崩さなかった。</p>',
        '<p>3. 彼は歴史に関する<span class="blank" data-correct-answer="該博"></span> な知識で、常に聴衆を驚かせた。</p>',
        '<p>4. 書類作成の手続きが<span class="blank" data-correct-answer="煩雑"></span> になりすぎて、かえって時間がかかっている。</p>',
        '<p>5. 異なる意見を持つ人々に対しても<span class="blank" data-correct-answer="寛容"></span> な姿勢を持つことが大切だ。</p>'
    ];

    const questionsContainer = document.getElementById('questions'); // Corrected variable name for clarity
    const answers = ["寛容", "該博", "煩雑", "専横", "謙虚"];
    ...
    submitBtn.addEventListener('click', () => {
        ...
        if (correctCount === totalQuestions) {
            ...
            <p>Test Completed!</p>
            <p>Result:You got (${correctCount}) correct answers out of (${totalQuestions}) quesitons!</p>
            <p>Your Score: ${percentage.toFixed(0)}%</p>
            <p style="font-size:20px; color:green; font-weight:bold;">A perfect score! Wonderful!</p>
        `;
        } else {
            resultsArea.innerHTML = `
            <p>Test Completed!</p>
            <p>Result:You got (${correctCount}) correct answers out of (${totalQuestions}) quesitons!</p>
            <p>Your Score: ${percentage.toFixed(0)}%</p>
            <p style="font-size:20px; font-weight:bold;">Let's strive for a perfect score!</p>
        `;
        }
